...
---------
    ...
    DEFAULT_CHAT_FRAME:AddMessage("    Locale: |cFF00FF00"..BGD_Prefs.locale, 1.0, 0.5, 0.0)
...
---------
    ...
    BGD_Opt_Safe:SetText( "SAFE: |cFF00FF00" ..call )
...
---------
    if (BGD_Prefs.BGChatTemp == "INSTANCE_CHAT") then
        UIDropDownMenu_SetText(BGD_Opt_Drop1, "Instance")
    ...
    elseif (BGD_Prefs.BGChatTemp == "RAID_WARNING") then
        UIDropDownMenu_SetText(BGD_Opt_Drop1, "Raid Warning")
    ...
    elseif (BGD_Prefs.BGChatTemp == "SELF_WISPER") then
        UIDropDownMenu_SetText(BGD_Opt_Drop1, "Self whisper (debug)")
    end
    ...
    elseif (BGD_Prefs.RaidChatTemp == "RAID_WARNING") then
        UIDropDownMenu_SetText(BGD_Opt_Drop2, "Raid Warning")
